  ...
  return html`
    <div class=${styles['template-container']}>
      ...
      <div
        ...
        <div class=${styles['expand__container']} id="restaurant-info-container">
        ...
        <div class=${styles['expand__container']} id="store__details__container">
    ...
    weekdayTemplate(weekday, showDeliveryDetails, toggleDay, weekdays)
        ...
        <div class=${styles['store__details-confirm-button__container']}>
          <button class=${styles['store__details-confirm-button']}>Confirm</button>
        </div>
      </div>
...
const weekdayTemplate = (
  ...
  weekdays
   ...
   <div class=${styles['weekday__container']} id="weekday__container-${weekday}">
        <div @click=${toggleDay} class=${styles['weekday-button']} data-id=${weekday}>${weekday}</div>
            <div class=${styles['store-details__main-container']} id="store-details__main-container-${weekday}">
                    <div class=${styles['time-selector__main-container']}>
                        <div class=${styles['time-selector__inner-container']}>
                            ...
                            <select id="open-selector-${weekday}" class=${styles['time-selector']}>${generateHours()}</select>
                        </div>
                        <div class=${styles['time-selector__inner-container']}>
                            <label class=${styles['time-selector-label']} for="${weekday}-close-selector">close</label>
                            <select id="close-selector-${weekday}" class=${styles['time-selector']}>${generateHours()}</select>
                            </div>
                        </div>
                    ...
                    <div class=${styles['delivery-day-input-container']}>
                        ...
                        <label for="cutoff-weekday-${weekday}" class=${styles['delivery-day-arrival-time-text']}>Order placement deadline</label>
                            <select id="cutoff-weekday-${weekday}" class=${styles['delivery-arrival-cutoff-weekday']}>
                            ${weekdays.map(
  (day) =>
